...
const descriptions: Record<keyof typeof analysisToolSpecs, string> = {
  ...
  query_distribution_analysis: "Query the distribution of an event metric with optional event filters. The supported count-based metrics do not take a property; use query_event_analysis group_by to break results down by a property.",
